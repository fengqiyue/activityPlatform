...
router.get('/barrage', function (req, res) { //弹幕墙
  res.redirect("https://open.weixin.qq.com/connect/oauth2/authorize?appid=wxc786068b2326a6b4&redirect_uri=http://house.duanpengfei.com:3030/weixin&response_type=code&scope=SCOPE&state=1#wechat_redirect");
  res.render('barrage');
});
